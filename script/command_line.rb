...
CommandLine::Script_command_line.run do
  if CommandLine::Script_command_line.command_line_opts[:help]
    ...
    test_executable = TestExecutable.new_from_path(required_library_file)
		unit_commandline = CommandLine.new(test_executable: test_executable, unit_class: unit.model_class?, argv: ARGV[1..-1])
