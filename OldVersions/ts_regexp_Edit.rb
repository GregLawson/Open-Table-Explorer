...
WhiteSpacePattern=' '
WhiteSpace=' '
WhiteEditor=Regexp_Edit.new(WhiteSpacePattern,WhiteSpace,false)	
Keditor=Regexp_Edit.new('K','K')
KCeditor=Regexp_Edit.new('KC','KC',false)
RowsRegexp='(<tr.*</tr>)'
RowsEditor=Regexp_Edit.new(RowsRegexp,'',false)
RowsEdtor2=Regexp_Edit.new('\s*(<tr.*</tr>)',' <tr height=14>
...
KCETeditor=Regexp_Edit.new('KCET[^
