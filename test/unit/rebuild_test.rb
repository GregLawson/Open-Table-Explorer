...
#	assert_equal([{name: :'Open-Table_Explorer', dir: This_code_repository.path}], repository_directories)
	repository_directories = Rebuild.named_repository_directories(Directories_of_repositories, Repository_glob)
#	assert_include([{name: :'Open-Table_Explorer', dir: This_code_repository.path}], repository_directories)
