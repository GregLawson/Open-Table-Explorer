...
require_relative '../../app/models/EEG.rb'
class EegTest < TestCase
  def test_initialize
  end # initialize

  def test_all
#    assert_includes('href', UriParse.column_names)
...
#    assert_equal(64_810_937, streamCall.id)
#    assert_equal_sets(%w(stream_method stream_links), StreamMethodCall.association_names)
