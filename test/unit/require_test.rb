...
class RequireTest < TestCase
  ...
  module Examples # usually constant objects of the type (easy to understand (perhaps impractical) examples for testing)
    ...
    File_with_no_requires = '/dev/null'.freeze
    File_with_minimum_requires = 'app/models/ruby_lines_storage.rb'.freeze
  end # Examples
  include Examples
  ...
  def test_scan_unit
    ...
    Unit::Executable.edit_files.each do |path|
      ...
      parse.enumerate(:each) do |output|
        ...
        assert_includes(%w(require require_relative), output[:require_command], output)
      end # each
  ...
  def test_Require_attributes
    executing_requires = Require.new(path: $PROGRAM_NAME)
